...
$$\begin{align}
    \mathcal{L}(A, Y) &= \langle G_t, A \rangle + \iota_{\| \cdot \| \leq \eta}(A) + \langle Y, L(A) + b \rangle \nonumber \\
        &= \iota_{\| \cdot \| \leq \eta}(A) + \langle G_t + L^\dagger(Y), A \rangle + \langle Y, b \rangle
\end{align}$$
...
$$\begin{align}
    A^*(Y)
        ...
        &= \arg\min_{A \in \mathbb{R}^{m \times n}} \iota_{\| \cdot \| \leq \eta}(A) + \langle G_t + L^\dagger(Y), A \rangle + \cancel{\langle Y, b \rangle} \nonumber \\
